...
public class MainActivity extends Activity {
  ...
  public void onClick(View v) {
    if (v.getId() == R.id.button1) {
      ...
      intent.putExtra(MediaService.ACTION_MEDIA_URL_KEY, data);
      intent.putExtra(MediaService.ACTION_MEDIA_TITLE_KEY, title);
      intent.putExtra(MediaService.ACTION_MEDIA_ARTIST_KEY, artist);
      startService(intent);
    }
